...
/* Broken glibc implementations use __ss_family instead of ss_family. */
...
/* Define to 1 if you have the <feature_tests.h> header file. */
/* #undef HAVE_FEATURE_TESTS_H */
...
/* Define to 1 if you have the `usb_interrupt_read' function. */
