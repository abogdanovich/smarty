...
ZEND_DECLARE_MODULE_GLOBALS(OW)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(OW_globals_id, zend_OW_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(OW_globals_id, zend_OW_globals *, error_code )
#else
#define SWIG_ErrorMsg() (OW_globals.error_msg)
#define SWIG_ErrorCode() (OW_globals.error_code)
#endif
...
static void OW_init_globals(zend_OW_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void OW_destroy_globals(zend_OW_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_OW_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_OW_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_get) {
  ...
  result = (char *)get((char const *)arg1);
  {
    if(!result) {
      ZVAL_NULL(return_value);
    } else {
...
ZEND_NAMED_FUNCTION(_wrap_put) {
  ...
  result = (int)put((char const *)arg1,(char const *)arg2);
  {
    ZVAL_LONG(return_value,result);
  }
  return;
...
ZEND_NAMED_FUNCTION(_wrap_opt) {
  ...
  result = (int)opt(arg1,(char const *)arg2);
  {
    ZVAL_LONG(return_value,result);
  }
  return;
...
static zend_function_entry OW_functions[] = {
 SWIG_ZEND_NAMED_FE(version,_wrap_version,NULL)
 SWIG_ZEND_NAMED_FE(init,_wrap_init,NULL)
 SWIG_ZEND_NAMED_FE(get,_wrap_get,NULL)
 SWIG_ZEND_NAMED_FE(put,_wrap_put,NULL)
 SWIG_ZEND_NAMED_FE(finish,_wrap_finish,NULL)
 SWIG_ZEND_NAMED_FE(set_error_print,_wrap_set_error_print,NULL)
 SWIG_ZEND_NAMED_FE(get_error_print,_wrap_get_error_print,NULL)
 SWIG_ZEND_NAMED_FE(set_error_level,_wrap_set_error_level,NULL)
 SWIG_ZEND_NAMED_FE(get_error_level,_wrap_get_error_level,NULL)
 SWIG_ZEND_NAMED_FE(opt,_wrap_opt,NULL)
 SWIG_ZEND_NAMED_FE(swig_OW_alter_newobject,_wrap_swig_OW_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_OW_get_newobject,_wrap_swig_OW_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry OW_module_entry = {
...
zend_module_entry* SWIG_module_entry = &OW_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &OW_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(OW)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(OW, OW_init_globals, OW_destroy_globals);
