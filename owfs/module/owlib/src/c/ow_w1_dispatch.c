/*
$Id: ow_w1_dispatch.c,v 1.39 2012/09/28 20:43:34 alfille Exp $
...
void * W1_Dispatch( void * v )
{
	...
	while ( FILE_DESCRIPTOR_VALID( Inbound_Control.w1_monitor->pown->file_descriptor ) ) {
